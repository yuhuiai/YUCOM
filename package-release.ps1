...
$versionName = 'YUCOM-V1.2.0-Linux'
...
Copy-Item -LiteralPath (Join-Path $projectRoot 'dist\YUCOM-Linux-arm64') -Destination $versionRoot
Copy-Item -LiteralPath (Join-Path $projectRoot 'dist\YUCOM-Linux-amd64') -Destination $versionRoot
Copy-Item -LiteralPath (Join-Path $projectRoot 'scripts\启动YUCOM.sh') -Destination $versionRoot
